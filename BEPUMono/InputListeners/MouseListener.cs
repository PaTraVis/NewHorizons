    ...
    public class MouseListener : InputListener
    {
        ...
        internal override void Update(GameTime gameTime)
        {
            ...
            if (_previousState.X != _currentState.X || _previousState.Y != _currentState.Y)
                MouseMoved?.Invoke(this, new MouseEventArgs(gameTime.TotalGameTime, _previousState, _currentState));

            // Handle mouse wheel events.
            if (_previousState.ScrollWheelValue != _currentState.ScrollWheelValue)
                MouseWheelMoved?.Invoke(this, new MouseEventArgs(gameTime.TotalGameTime, _previousState, _currentState));

...
namespace BEPUMono.Physics
{
    public class GravitationField : ForceField
    {
        /// <summary>
        ...
        public GravitationField(ForceFieldShape shape, Vector3 origin, float multiplier, float maxAcceleration)
            : base(shape)
        {
